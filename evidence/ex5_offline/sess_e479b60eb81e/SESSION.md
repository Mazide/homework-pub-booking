# Session sess_e479b60eb81e

**Scenario:** edinburgh-research
**Created:** 2026-05-25T14:00:33.044659+00:00
...
All parameters are already provided above. Do NOT call handoff_to_structured — this is a loop-only task.
...
REQUIRED tool sequence (all four tools MUST run, in order):
  ...
  5. complete_task(result={'flyer': 'workspace/flyer.md', 'venue': <id>})

Do NOT call complete_task until you have called generate_flyer. Do NOT call handoff_to_structured. The scenario is graded by the existence of workspace/flyer.md. Exact tool names and argument shapes are in each tool's docstring.
