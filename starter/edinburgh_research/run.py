    ...
    with example_sessions_dir("ex5-edinburgh-research", persist=True) as sessions_root:
        session = create_session(
            ...
            task=(
                ...
                "All parameters are already provided above. "
                "Do NOT call handoff_to_structured — this is a loop-only task.\n\n"
                ...
                "Exact tool names and argument shapes are in each tool's docstring."
            ),
